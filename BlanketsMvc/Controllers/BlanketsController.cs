...
namespace BlanketsMvc.Controllers
{
    public class BlanketsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Type,Size,Color,Pattern,Weight,Material,Rating")] Blankets blankets)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Type,Size,Color,Pattern,Weight,Material")] Blankets blankets)
        {
            if (id != blankets.Id)
            {
                return NotFound();
